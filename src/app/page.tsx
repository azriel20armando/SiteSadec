...
const palette = {
  primary: "#0033A1", // Azul SADC para realces e links
  accent: "#FFD100",  // Amarelo/dourado
  angolaRed: "#D21034",
  angolaBlack: "#000000",
  neutralBg: "#0B0B0B",
  neutralCard: "#121212",
  ...
  return (
    <main
      ...
      style={{
        ...
        "--angola-black": palette.angolaBlack,
    ...
    >
      {/* HEADER */}
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-black/30 bg-black/80 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <a href="#" className="flex items-center gap-3 group">
              <div className="w-9 h-9 rounded-xl flex items-center justify-center shadow-lg"
                   style={{ background: `linear-gradient(135deg,var(--angola-red),var(--accent))` }}>
                <span className="sr-only">Logotipo</span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
                  <path d="M12 2l2.5 6.5L21 11l-6.5 2.5L12 20l-2.5-6.5L3 11l6.5-2.5L12 2z" fill="currentColor" className="text-black" />
                </svg>
              </div>
              <div>
                <p className="text-sm font-semibold tracking-wide text-white leading-tight">Programa de Adesão</p>
            ...
            <nav className="hidden text-amber-50 md:flex items-center gap-6 text-sm">
              {[
                ...
                <a key={href} href={href} className="text-gray-200 hover:text-white transition-colors">{label}</a>
              ))}
            </nav>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a href="#beneficios" className="px-5 py-3 rounded-xl font-semibold" style={{ backgroundColor: "var(--accent)", color: "black" }}>Ver Benefícios</a>
                <a href="#recursos" className="px-5 py-3 rounded-xl font-semibold border border-white/20 hover:border-white/40">Guias & Documentos</a>
              </div>
              <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                {[
                  ...
                  <div key={i.k} className="rounded-2xl p-4 border border-white/10 bg-white/5">
                    <p className="text-sm text-gray-400">{i.k}</p>
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}>
              <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                <div className="aspect-[4/3] w-full"
                     style={{ background: `linear-gradient(135deg,var(--primary),var(--angola-red))` }} />
                <div className="absolute inset-0 p-4 flex items-end justify-between">
                  <span className="text-xs bg-black/60 px-3 py-1 rounded-full">SADC • AfCFTA • Angola</span>
                  <span className="text-xs bg-black/60 px-3 py-1 rounded-full">Comércio & Integração</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      {/* SOBRE */}
      <section id="sobre" className="py-16 md:py-24" style={{ backgroundColor: "#0F1115", color: "var(--neutral-text)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={c.title} className="rounded-2xl p-5 border border-white/10 bg-white/5">
          ...
          <aside className="space-y-4">
            <div className="rounded-2xl p-5 border border-white/10" style={{ backgroundColor: "var(--neutral-card)" }}>
              <p className="text-sm text-gray-400">Status sintetizado</p>
            ...
            <div className="rounded-2xl p-5 border border-white/10" style={{ backgroundColor: "var(--neutral-card)" }}>
              <p className="text-sm text-gray-400">Canais de Informação</p>
      ...
      {/* BENEFÍCIOS */}
      <section id="beneficios" className="py-16 md:py-24" style={{ backgroundColor: "#0A0C10", color: "var(--neutral-text)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* MARCOS / TIMELINE */}
      <section id="marcos" className="py-16 md:py-24" style={{ backgroundColor: "#0F1115", color: "var(--neutral-text)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ol className="mt-8 relative border-l border-white/10 pl-6 space-y-8">
            {[
              ...
              <li key={idx} className="ml-2">
                <div className="absolute -left-[9px] mt-1 w-4 h-4 rounded-full" style={{ backgroundColor: idx === 3 ? "var(--accent)" : "var(--primary)" }} />
                <div className="p-4 rounded-2xl border border-white/10 bg-white/5">
                  <p className="text-sm text-gray-400">{m.data}</p>
                  <p className="font-semibold">{m.titulo}</p>
                  <p className="text-sm text-gray-300">{m.detalhe}</p>
                </div>
              </li>
            ))}
          </ol>
      ...
      {/* RECURSOS / DOCUMENTOS */}
      <section id="recursos" className="py-16 md:py-24" style={{ backgroundColor: "#0A0C10", color: "var(--neutral-text)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <a key={r.href} href={r.href} target="_blank" rel="noreferrer"
                 className="rounded-2xl p-5 border border-white/10 bg-white/5 hover:border-white/30 transition-colors">
      ...
      {/* FAQ */}
      <section id="faq" className="py-16 md:py-24" style={{ backgroundColor: "#0F1115", color: "var(--neutral-text)" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 divide-y divide-white/10 border border-white/10 rounded-2xl overflow-hidden">
            {[
              ...
              <details key={i} className="group bg-white/5 open:bg-white/10 ">
                ...
                <div className="p-5 pt-0 text-gray-300 text-sm">{f.a}</div>
              </details>
            ))}
          </div>
        </div>
      ...
      {/* CONTACTO */}
      <section id="contacto" className="py-16 md:py-24" style={{ backgroundColor: "#090A0E", color: "var(--neutral-text)" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-3xl font-bold">Entre em contacto</h2>
          <p className="mt-2 text-gray-300">Use o formulário para dúvidas, parcerias e imprensa.</p>
          <form onSubmit={submit} className="mt-6 grid grid-cols-1 gap-4">
            ...
            {sent && (
              <p className="text-sm text-green-400">Mensagem registada localmente. Integre uma rota API para envio real (ex.: Formspree ou servidor).</p>
            )}
          </form>
        </div>
      </section>
      ...
      {/* FOOTER */}
      <footer className="py-10 border-t border-white/10" style={{ backgroundColor: "#07080C", color: "var(--neutral-text)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-sm flex flex-col md:flex-row gap-4 md:items-center md:justify-between">
          <p className="text-gray-400">© {new Date().getFullYear()} Programa de Adesão • República de Angola</p>
